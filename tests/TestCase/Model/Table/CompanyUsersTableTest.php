...
class CompanyUsersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('CompanyUsers') ? [] : ['className' => CompanyUsersTable::class];
        $this->CompanyUsers = TableRegistry::getTableLocator()->get('CompanyUsers', $config);
    }
